...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
        ...
        // 3-verify
        assert balanceBefore + withdrawAmount == balanceAfter : "Balance calculation error";
        if (balanceBefore + withdrawAmount == balanceAfter) {
            ...
            System.out.println(TestUtils.TEXT_COLOR_RED + "testWithDrawals: TC1 FAILED: balanceBefore + withdrawAmount != balanceAfter");
